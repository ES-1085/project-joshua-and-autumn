...
```{r select-var-ORG}
Organics2002 = select(organics_full, c(UNIQUE_ID, REPNO_ORG, TOTREP_ORG, TVS_EP_PCT, O_G_UGG, PHCTOT_UGG, PCB_T_UGG, DDT_T_NGG, DDE_T_NGG, DDD_T_NGG, PEST_UG_G, LIPIDS_NGG, CLOST_SP_G, MBT_C, DBT_C, TBT_C, TTBT_C))

Organics2002 <- Organics2002 %>%
  rename("O_G_" = "O_G_UGG", 
         "PHCTOT" = "PHCTOT_UGG", 
         "PCB" = "PCB_T_UGG", 
         "DDT" = "DDT_T_NGG", 
...
The amount values for the PAH containment `CHRYSENE_C` needs to be recoded from character values to numeric values. 
