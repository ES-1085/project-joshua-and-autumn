...
#stations_full = read_xls("/project/data/original_datasets/STAT2002.xls", sheet = 2, skip = 3)
...
```
##Load full datasets for desktop r (autumn's computer) (will delete later)
```{r load-data-desktop, warning=FALSE}
#stations_full = read_xls("C:/Users/pauly/Documents/project-joshua-and-autumn/data/original_datasets/STAT2002.xls", sheet = 2, skip = 3)
#sediments_full = read_excel("C:/Users/pauly/Documents/project-joshua-and-autumn/data/original_datasets/TXTR2002.xls", sheet = 2, skip = 3)
#PCBs_full = read_excel("C:/Users/pauly/Documents/project-joshua-and-autumn/data/original_datasets/PCBP2002.xls", sheet = 2, skip = 3)
#PAHs_full = read_excel("C:/Users/pauly/Documents/project-joshua-and-autumn/data/original_datasets/PAHS2002.xls", sheet = 2, skip = 3)
#organics_full = read_excel("C:/Users/pauly/Documents/project-joshua-and-autumn/data/original_datasets/GENO2002.xls", sheet = 2, skip = 3)
#inorganics_full = read_excel("C:/Users/pauly/Documents/project-joshua-and-autumn/data/original_datasets/INOR2002.xls", sheet = 2, skip = 3)
#textures_full = read_excel("C:/Users/pauly/Documents/project-joshua-and-autumn/data/original_datasets/TXTR2002.xls", sheet = 2, skip = 3)
```
...
```
Creates PAHs2002 dataframe with selected variables of interest.  These are principally contaminat concentrations with unique IDs associated with other data frames.

# Recode/combine categories
### Stations


```{r combine-loc-categories}
...
#visualizing correlations in data as a heatmap - only numeric values...
#dplyr::select(Texture_loc, where(is.numeric)) %>%
#visdat::vis_cor(Texture_loc, "pearson", "pairwise.complete.obs", facet)
...
write_csv(sediments_full, "/cloud/project/data/datasets_csv/sediments_full.csv")
write_csv(stations_full, "/cloud/project/data/datasets_csv/stations_full.csv")
write_csv(textures_full, "/cloud/project/data/datasets_csv/textures_full.csv")
#write_csv(inorganics_full, "/cloud/project/data/datasets_csv/inorganics_full.csv")
```

# Loading loc datasets as CSVs
``` {r saving-data_loc-into-csv-files}
write_csv(Texture_loc, "/cloud/project/data/datasets_csv/Texture_loc.csv")
write_csv(Organics_loc, "/cloud/project/data/datasets_csv/Organics_loc.csv")
#write_csv(Inorganics_loc, "/cloud/project/data/datasets_csv/Inorganics_loc.csv")
