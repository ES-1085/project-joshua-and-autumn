...
```{r select-var-ORG}
Organics2002 = select(organics_full, c(UNIQUE_ID, TVS_EP_PCT, O_G_UGG, PHCTOT_UGG, PCB_T_UGG, DDT_T_NGG, DDE_T_NGG, DDD_T_NGG, PEST_UG_G, LIPIDS_NGG, CLOST_SP_G, MBT_C, DBT_C, TBT_C, TTBT_C))
```
