...
``` {r type_of_organic-in-cape-ann-to-elizabeth-graph, warning = FALSE, fig.alt = "Pie chart of composition of general organic contaminats in inshore area from Cape Ann, MA to Cape Elizabeth, ME.  "}
Organics_long_no_na_no_zero %>%
