...
```{r calculate-sum-stats-organics, fig.align = "A table of summary statistics of total PCB concentrations grouped by general locations in the Gulf of Maine and arranged in descending order of mean total concentration.  Summary statistics include mean, standard deviation, count, and standard error.  Boston Inner Harbor has the highest mean total concentration in micrograms per gram of sediment, followed by Cape Ann to Cape Elizabeth.  Cape Cod Bay has the lowest mean concentrations."}
