...
Interpretation: This bar plot shows number of observations within the Organics dataset in each general location category.  The highest numbers of observations come from the Gulf of Maine >50m Isobath (offshore sediments), and Massachusetts Bays, Northwest Boston Harbor, and Cape Elizabeth to Rockland are all highly sampled as well.  Intertidal Atlantic Canada is the least sampled general location in our dataset.
