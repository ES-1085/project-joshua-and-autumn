...
Sum_PAH_site %>%
  filter(site.x %in% c("In Piscataqua River NE of Outer Cutts Cove", "Piscataqua River N of Pierce Is.","York River", "Kennebunk River", "Portland Fore River", "Kennebec River to Bath", "Penobscot River to Bangor")) %>%
  ggplot(aes(x = fct_rev(fct_reorder(site.x, mean_PAH)), y = mean_PAH, fill = site.x))+
